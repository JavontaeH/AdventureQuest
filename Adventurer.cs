...
namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        {
            return ($"{Name} has a robe that is {ColorfulRobe.Length} long and has the colors of {String.Join(", ", ColorfulRobe.Colors)} and a hat that is {ShinyHat.ShininessDescription}.");
        }
    }
}